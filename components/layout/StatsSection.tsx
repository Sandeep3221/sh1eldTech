...
export function StatsSection() {
  ...
  const R_GLOBE = Math.min(windowSize.w, windowSize.h) * (isMobile ? 0.275 : 0.375);
  ...
  return (
    ...
    >
      <div 
        className="relative w-[95vw] max-w-[1200px] h-[70vh] sm:h-[80vh] max-h-[850px] z-20 grid grid-cols-2 grid-rows-2 gap-2 sm:gap-6 lg:gap-8 pointer-events-auto"
        style={{
      ...
      >
        ...
        >
          <div className="absolute top-3 left-3 sm:top-8 sm:left-8 flex flex-col items-start w-[calc(100%-1rem)] sm:w-[calc(100%-2rem)] max-w-[260px]">
            ...
            <h3 className="text-xl sm:text-3xl lg:text-5xl font-heading font-extrabold text-[#08090C] mb-1 tracking-tight flex items-center truncate w-full">
        ...
        <div
          className={`relative bg-white/90 backdrop-blur-3xl rounded-tr-[32px] sm:rounded-tr-[40px] transition-all duration-[1200ms] ease-[cubic-bezier(0.16,1,0.3,1)] delay-[100ms]
            ${isVisible ? 'translate-x-0 translate-y-0 opacity-100 scale-100' : '-translate-x-[15%] translate-y-[15%] opacity-0 scale-95'}`}
        >
          <div className="absolute top-3 right-3 sm:top-8 sm:right-8 flex flex-col items-end text-right w-[calc(100%-1rem)] sm:w-[calc(100%-2rem)] max-w-[260px]">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#08090C] flex items-center justify-center mb-3 sm:mb-4 shadow-inner">
              <MapPin className="w-5 h-5 sm:w-6 sm:h-6 text-pink-300" />
            </div>
            <h3 className="text-xl sm:text-3xl lg:text-5xl font-heading font-extrabold text-[#08090C] mb-1 tracking-tight flex items-center truncate w-full justify-end">
              Sikkim
            </h3>
            <p className="text-[10px] sm:text-[12px] font-sans font-bold text-slate-700 uppercase tracking-widest leading-relaxed">
        ...
        <div
          className={`relative bg-white/90 backdrop-blur-3xl rounded-bl-[32px] sm:rounded-bl-[40px] transition-all duration-[1200ms] ease-[cubic-bezier(0.16,1,0.3,1)] delay-[200ms]
            ${isVisible ? 'translate-x-0 translate-y-0 opacity-100 scale-100' : 'translate-x-[15%] -translate-y-[15%] opacity-0 scale-95'}`}
        >
          <div className="absolute bottom-3 left-3 sm:bottom-8 sm:left-8 flex flex-col items-start w-[calc(100%-1rem)] sm:w-[calc(100%-2rem)] max-w-[260px]">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#08090C] flex items-center justify-center mb-3 sm:mb-4 shadow-inner">
        ...
        <div
          className={`relative bg-white/90 backdrop-blur-3xl rounded-br-[32px] sm:rounded-br-[40px] transition-all duration-[1200ms] ease-[cubic-bezier(0.16,1,0.3,1)] delay-[300ms]
            ${isVisible ? 'translate-x-0 translate-y-0 opacity-100 scale-100' : '-translate-x-[15%] -translate-y-[15%] opacity-0 scale-95'}`}
        >
          <div className="absolute bottom-3 right-3 sm:bottom-8 sm:right-8 flex flex-col items-end text-right w-[calc(100%-1rem)] sm:w-[calc(100%-2rem)] max-w-[260px]">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-[#08090C] flex items-center justify-center mb-3 sm:mb-4 shadow-inner">
